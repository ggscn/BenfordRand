...
class benford_rand{
    ...
    public:
        int rand(int pool_size = 100000){
            ...
            int first_digit_pool[first_digit_arr_size];
            int arr_counter = 0;
            ...
            std::random_shuffle(&first_digit_pool[0], &first_digit_pool[first_digit_arr_size]);
            ...
            int second_digit_pool[second_digit_arr_size];
            arr_counter = 0;
            //Creates pool of numbers following Benford's law to pull randomly from
            for (int i = 0 ; i < 10; i++){
                double probability = get_probability(i*1.0, 2);
            ...
            std::random_shuffle(&second_digit_pool[0], &second_digit_pool[second_digit_arr_size]);
            ...
            int third_digit_pool[third_digit_arr_size];
            arr_counter = 0;
            //Creates pool of numbers following Benford's law to pull randomly from
            for (int i = 0 ; i < 10; i++){
                double probability = get_probability(i*1.0, 3);
            ...
            std::random_shuffle(&third_digit_pool[0], &third_digit_pool[third_digit_arr_size]);
            ...
            int fourth_digit_pool[fourth_digit_arr_size];
            arr_counter = 0;
            //Creates pool of numbers following Benford's law to pull randomly from
            for (int i = 0 ; i < 10; i++){
                double probability = get_probability(i*1.0, 4);
            ...
            std::random_shuffle(&fourth_digit_pool[0], &fourth_digit_pool[fourth_digit_arr_size]);
